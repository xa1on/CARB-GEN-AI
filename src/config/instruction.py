...
SORTER_SYS_INST = [
    ...
    """Terms like "inclusionary zoning", "density bonus", "commercial linkage fees", etc. typically also relevant to housing, zoning, or building/construction sections/chapters/titles.""",
