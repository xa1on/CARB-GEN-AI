...
CSV_HEADER = ["Municipality", "County", "Policy Type", "Number", "Requires Update Date", "Link"]
        ...
        for line in csv_read:
            if line[0].upper() == muni.upper() and line[3] == 'Y':
                ...
                if checking:
                    ...
                    log(f"{"REQUIRES UPDATE: " if VERBOSE else ""}{line[0]}: {line[2]} - {line[4]} ({update_date})\n")
